...
import org.klyx.exo.entity.meta.HumanoidArm;
...
public class AvatarMeta extends LivingEntityMeta {
    ...
    private static final MetaAccessor<HumanoidArm> HUMANOID_ARM = new MetaAccessor<>(15, MetaType.HUMANOID_ARM, HumanoidArm.RIGHT);
    private static final MetaAccessor<Byte> SKIN_CUSTOMIZATION = new MetaAccessor<>(16, MetaType.BYTE, (byte) 0);
