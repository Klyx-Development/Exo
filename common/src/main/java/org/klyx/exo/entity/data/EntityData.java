...
public class EntityData {
    ...
    private final ExoEntityType type;
    ...
    private static @Nullable AbstractObjectData validateObjectData(@Nullable AbstractObjectData data, ExoEntityType type) {
        if (data == null) return null;
        if (!data.boundType().equals(type)) {
            throw new IllegalStateException("Object data bound to " + data.boundType() + " is not compatible with entity type " + type);
        }
        return data;
    }
    ...
    public static final class Builder implements Buildable<EntityData> {
        ...
        public Builder entityType(ExoEntityType type) {
            this.type = type;
            return this;
        }
