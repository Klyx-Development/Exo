...
public class FishingBobberMeta extends EntityMeta {
    ...
    private static final MetaAccessor<Integer> HOOKED_ENTITY_ID = new MetaAccessor<>(8, MetaType.INT, 0);
    private static final MetaAccessor<Boolean> CATCHABLE = new MetaAccessor<>(9, MetaType.BOOLEAN, false);
