...
public abstract class LivingEntityMeta extends EntityMeta {
    ...
    private static final MetaAccessor<Byte> HAND_STATES =
            new MetaAccessor<>(8, MetaType.BYTE, (byte) 0);
    private static final MetaAccessor<Float> HEALTH =
            new MetaAccessor<>(9, MetaType.FLOAT, 1.0f);
    private static final MetaAccessor<List<ExoParticle>> EFFECT_PARTICLES =
            new MetaAccessor<>(10, MetaType.PARTICLES, List.of());
    private static final MetaAccessor<Boolean> EFFECT_AMBIENCE =
            new MetaAccessor<>(11, MetaType.BOOLEAN, false);
    private static final MetaAccessor<Integer> ARROW_COUNT =
            new MetaAccessor<>(12, MetaType.INT, 0);
    private static final MetaAccessor<Integer> STINGER_COUNT =
            new MetaAccessor<>(13, MetaType.INT, 0);
    private static final MetaAccessor<Optional<ExoBlockPos>> SLEEPING_POS =
            new MetaAccessor<>(14, MetaType.OPTIONAL_BLOCK_POS, Optional.empty());
    ...
    public LivingEntityMeta setEffectParticles(List<ExoParticle> particles) {
        set(EFFECT_PARTICLES, particles);
        return this;
    }

    public List<ExoParticle> getEffectParticles() {
    ...
    public LivingEntityMeta setSleepingPos(ExoBlockPos pos) {
        set(SLEEPING_POS, Optional.ofNullable(pos));
        return this;
    }

    public Optional<ExoBlockPos> getSleepingPos() {
