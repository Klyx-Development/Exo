...
public class FireballMeta extends EntityMeta {
    ...
    public FireballMeta setItem(ItemStack itemStack) {
        set(ITEM_STACK, itemStack);
        return this;
    }

    public FireballMeta setItem(org.bukkit.inventory.ItemStack itemStack) {
